...
\end{DoxyItemize}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md118}{}\doxysection{Requirements}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md118}
...
\end{DoxyItemize}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md119}{}\doxysection{Status}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md119}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md120}{}\doxysection{Upgrade Notes}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md120}
\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md121}{}\doxysubsubsection{S\+D\+L\+\_\+\+Get\+Pref\+Path() usage when upgrading Win\+R\+T apps from S\+D\+L 2.\+0.\+3}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md121}
...
Apps that wish to get their Roaming folder\textquotesingle{}s path can do so either by using S\+D\+L\+\_\+\+Win\+R\+T\+Get\+F\+S\+Path\+U\+T\+F8(), S\+D\+L\+\_\+\+Win\+R\+T\+Get\+F\+S\+Path\+U\+N\+I\+C\+O\+D\+E() (which returns a U\+C\+S-\/2/wide-\/char string), or directly through the Win\+RT class, Windows.\+Storage.\+Application\+Data.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md122}{}\doxysection{Setup, High-\/\+Level Steps}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md122}
...
\end{DoxyEnumerate}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md123}{}\doxysection{Setup, Detailed Steps}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md123}
\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md124}{}\doxysubsection{1. Create a new project}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md124}
Create a new project using one of Visual C++\textquotesingle{}s templates for a plain, non-\/\+X\+A\+ML, \char`\"{}\+Direct3\+D App\char`\"{} (X\+A\+ML support for S\+D\+L/\+Win\+RT is not yet ready for use). If you don\textquotesingle{}t see one of these templates, in Visual C++\textquotesingle{}s \textquotesingle{}New Project\textquotesingle{} dialog, try using the textbox titled, \textquotesingle{}Search Installed Templates\textquotesingle{} to look for one.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md125}{}\doxysubsection{2. Remove unneeded files from the project}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md125}
...
\end{DoxyItemize}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md126}{}\doxysubsection{3. Add references to S\+D\+L\textquotesingle{}s project files}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md126}
...
Your project is now linked to S\+DL\textquotesingle{}s project, insofar that when the app is built, S\+DL will be built as well, with its build output getting included with your app.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md127}{}\doxysubsection{4. Adjust Your App\textquotesingle{}s Build Settings}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md127}
...
\item {\bfseries{Optional\+: to disable precompiled headers (which can produce \textquotesingle{}\mbox{\hyperlink{stdafx_8h_source}{stdafx.\+h}}\textquotesingle{}-\/related build errors, if setup incorrectly\+:}} in the left-\/hand list, select \char`\"{}\+Precompiled Headers\char`\"{}, then change the setting for \char`\"{}\+Precompiled 
...
\end{DoxyEnumerate}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md128}{}\doxysubsection{5. Add a Win\+R\+T-\/appropriate main function, and a blank-\/cursor image, to the app.}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md128}
A few files should be included directly in your app\textquotesingle{}s M\+S\+VC project, specifically\+:
\begin{DoxyEnumerate}
\item a Win\+R\+T-\/appropriate main function (which is different than main() functions on other platforms)
...
For non-\/\+C++ projects, you will need to call S\+D\+L\+\_\+\+Win\+R\+T\+Run\+App from your language\textquotesingle{}s main function, and generate S\+D\+L2-\/\+Win\+R\+T\+Resources.\+res manually by using {\ttfamily rc} via the Developer Command Prompt and including it as a $<$\+Win32\+Resource$>$ within the first $<$\+Property\+Group$>$ block in your Visual Studio project file.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md129}{}\doxysubsection{6. Add app code and assets}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md129}
At this point, you can add in S\+D\+L-\/specific source code. Be sure to include a C-\/style main function (ie\+: {\ttfamily int main(int argc, char $\ast$argv\mbox{[}$\,$\mbox{]})}). From there you should be able to create a single {\ttfamily S\+D\+L\+\_\+\+Window} (Win\+RT apps can only have one window, at present), as well as an {\ttfamily S\+D\+L\+\_\+\+Renderer}. Direct3D will be used to draw content. Events are received via S\+DL\textquotesingle{}s usual event functions ({\ttfamily S\+D\+L\+\_\+\+Poll\+Event}, etc.) If you have a set of existing source files and assets, you can start adding them to the project now. If not, or if you would like to make sure that you\textquotesingle{}re setup correctly, some short and simple sample code is provided below.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md130}{}\doxysubsubsection{6.\+A. ... when creating a new app}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md130}
...
\end{DoxyVerb}
\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md131}{}\doxysubsubsection{6.\+B. Adding code and assets}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md131}
...
A list of unsupported C A\+P\+Is can be found at \href{http://msdn.microsoft.com/en-us/library/windows/apps/jj606124.aspx}{\texttt{ http\+://msdn.\+microsoft.\+com/en-\/us/library/windows/apps/jj606124.\+aspx}}
...
A list of supported Win32 A\+P\+Is for Win\+RT apps can be found at \href{http://msdn.microsoft.com/en-us/library/windows/apps/br205757.aspx}{\texttt{ http\+://msdn.\+microsoft.\+com/en-\/us/library/windows/apps/br205757.\+aspx}}. To note, the list of supported Win32 A\+P\+Is for Windows Phone 8.\+0 is different. ~\newline
 That list can be found at \href{http://msdn.microsoft.com/en-us/library/windowsphone/develop/jj662956(v=vs.105).aspx}{\texttt{ http\+://msdn.\+microsoft.\+com/en-\/us/library/windowsphone/develop/jj662956(v=vs.\+105).\+aspx}}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md132}{}\doxysubsection{7. Build and run your app}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md132}
Your app project should now be setup, and you should be ready to build your app. ~\newline
 To run it on the local machine, open the Debug menu and choose \char`\"{}\+Start 
\+Debugging\char`\"{}. This will build your app, then run your app full-\/screen. To switch out of your app, press the Windows key. Alternatively, you can choose to run your app in a window. To do this, before building and running your app, find the drop-\/down menu in Visual C++\textquotesingle{}s toolbar that says, \char`\"{}\+Local Machine\char`\"{}. Expand this by clicking on the arrow on the right side of the list, then click on Simulator. Once you do that, any time you build and run the app, the app will launch in window, rather than full-\/screen.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md133}{}\doxysubsubsection{7.\+A. Running apps on older, A\+R\+M-\/based, \char`\"{}\+Windows R\+T\char`\"{} devices}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md133}
...
\end{DoxyEnumerate}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md134}{}\doxysection{Troubleshooting}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md134}
\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md135}{}\doxysubsubsection{Build fails with message, \char`\"{}error L\+N\+K2038\+: mismatch detected for \textquotesingle{}vccorlib\+\_\+lib\+\_\+should\+\_\+be\+\_\+specified\+\_\+before\+\_\+msvcrt\+\_\+lib\+\_\+to\+\_\+linker\textquotesingle{}\char`\"{}}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md135}
...
\end{DoxyItemize}\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md136}{}\doxysubsubsection{Mouse-\/motion events fail to get sent, or S\+D\+L\+\_\+\+Get\+Mouse\+State() fails to return updated values}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md136}
This may be caused by a bug in Windows itself, whereby hiding the mouse cursor can cause mouse-\/position reporting to fail.

S\+DL provides a workaround for this, but it requires that an app links to a set of Win32-\/style cursor image-\/resource files. A copy of suitable resource files can be found in {\ttfamily src/main/winrt/}. Adding them to an app\textquotesingle{}s Visual C++ project file should be sufficient to get the app to use them.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md137}{}\doxysubsubsection{S\+D\+L\textquotesingle{}s Visual Studio project file fails to open, with message, \char`\"{}\+The system can\textquotesingle{}t find the file specified.\char`\"{}}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md137}
...
Once you install these components, try re-\/launching Visual Studio, and re-\/opening the S\+DL project file. If you still get the error dialog, try using the Output window, again, seeing what Visual Studio says about it.\hypertarget{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md138}{}\doxysubsubsection{Game controllers / joysticks aren\textquotesingle{}t working!}\label{md__s_d_l_docs__r_e_a_d_m_e-winrt_autotoc_md138}
